...
export function helperText (topic) {
  ...
  // allow topic to be an object that holds parameters (such as an address)
  switch (topic) {
    case modalTopic.UnlockMetaMask:
      return {
        title: 'MetaMask is locked',
        text: 'Please unlock Metamask by entering your password.\n',
        followUp: {
          target: modalTopic.educateAboutMetaMask // again, this is just to test the link funcitonality
        }
      }
    case modalTopic.NoMetaMask:
      return {
        title: topic,
