...
contract("ConceptRegistry", function(accounts) {
    ...
    it("should not be able to create a second concept from the MEW with same data", async () => {
        ...
        assert.isNotTrue(await conReg.conceptExists.call(createdConceptAddressS), "a new concept should NOT have been created")
    });
    it("should be able to create another concept from the MEW", async () => {
    ...
    it("shouldn't be the same address for both concepts", async () => {
